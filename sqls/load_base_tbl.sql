insert into source.base_data with cte as (SELECT s.crypto,
                                          ...
                                          GROUP BY s.crypto, s.id, s.usd, s.usd_24h_change, s.usd_24h_vol, s.usd_market_cap, s2.load_date), scores as (SELECT date_format(load_date, '%Y-%m-%d %H:00:00') load_dt,
